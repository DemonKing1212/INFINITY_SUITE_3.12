...
if (mUnlockSound != null) {
    ...
    private void updateSystemAnimationStyleAvailability() {
        ...
        if (isPerfOverrideEnabled) {
            final ContentResolver resolver = getActivity().getContentResolver();
            if (Settings.System.getInt(resolver, KEY_SYSTEM_ANIMATION_STYLE, -1) == -1) {
                Settings.System.putInt(resolver, KEY_SYSTEM_ANIMATION_STYLE, 4);
                mSystemAnimationStylePref.setValue("4");
            }
        }
    }
